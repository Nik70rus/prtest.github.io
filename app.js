        ...
        app.innerHTML = `
            <div class="method-screen">
                ...
                <div class="method-container">
                    ...
                    <div class="key-points"><p><b>Ключевые особенности:</b> Радикал — устойчивая акцентуация. В чистом виде редки. Личность — сочетание 2-4 радикалов. Методика прикладная. <b>Рекомендуемый возраст: 16+</b></p></div>
                    <div class="nav-buttons">
